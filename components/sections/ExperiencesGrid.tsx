    ...
    <section ref={sectionRef} className="relative z-10 py-32 bg-black">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <motion.h2
          ...
          className="font-[family-name:var(--font-heading)] text-7xl font-bold text-white tracking-tight leading-none px-8"
        >
          This week in Madrid
        </motion.h2>
        ...
        <div className="mt-12 flex items-stretch gap-6">
          ...
          <motion.div
            ...
            className="w-16 shrink-0 self-stretch rounded-xl"
            style={{
          ...
          <ul className="flex-1 grid grid-cols-3 gap-6">
            {experiences.map((exp, i) => (
              <motion.li
                ...
                className="group rounded-2xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-300 cursor-pointer shadow-lg shadow-black/50"
              >
